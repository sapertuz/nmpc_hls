...
open_project nmpc_hls_pso
set_top nonlinear_solver_wrapper
add_files ../main_hls_pso.cpp -cflags "-DSNIFFBOT_CONFIG -DPSO_CONFIG -std=c++11"
add_files ../hls_system.hpp
add_files ../hls_sniffbot.hpp
add_files ../hls_inverted_pendulum.hpp
add_files ../hls_pso.hpp
add_files ../fast_sin_cos.hpp
add_files ../aux_functions.hpp
add_files -tb ../main_hls_pso.cpp -cflags "-DDEBUG_SYSTEM -DSNIFFBOT_CONFIG -DDEBUG -DPSO_CONFIG -std=c++11 -Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
